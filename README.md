...
It is meant merely for didactic purposes. Refer to the [PM4py](https://github.com/process-intelligence-solutions/pm4py) Python library for state-of-the-art, production-ready tools for process mining.
...
2. "*causality*" -- or better, asymmetric conditioning -- ($A \rightarrow B$): $A > B$ happens, but never $B > A$,
